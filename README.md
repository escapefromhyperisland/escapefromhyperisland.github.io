...
Exploring Code is a five week dive into the weird web, as students are introduced to creative coding. The Frontend Developer students are challenged in building individual browser games adhering to a theme, defined by their teams. All the games are then added into a carousel game engine where one level  leads to the next.

[PLAY THE GAME](https://escapefromhyperisland.github.io/)
